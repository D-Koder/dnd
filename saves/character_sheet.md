...
- **Name:** Raken
- **Species/type:** Coralkin
- **Class:** water/earth-fueled Tech Mage Schemer
...
- **Body:** (empty)
- **Feet:** (empty)
- **Accessory 1:** Relic fragment (reactive)
- **Accessory 2:** (empty)
...
- **CHA:** 12 (+1)
- **Hit Die:** d8
*Real D&D 5e math — modifier = floor((score-10)/2). See world_bible.md → Rules of This World → How Stats Work.*

## Defenses
- **Armor Class:** 11 *(10 + Dex modifier)*
- **Passive Perception:** 12 *(10 + Wis modifier)*
...
## Attacks
- **Focus Pulse** (ranged, INT) — d6 + mod, force damage, costs 1 Magic Reserve. A discharge of grounded magic through the focus-tool.
- **Improvised Strike** (melee, DEX) — d4 + mod, bludgeoning damage. Grab whatever's at hand and swing — no resource cost, always available.

## Skills
- **Relic Read** (INT) — Sense and interpret old-tech signatures. *(Proficient)*
- **Scheme** (CHA) — Fast-talk, misdirect, find the angle. *(Untrained)*
- **Ground & Channel** (WIS) — Draw on stone/water surroundings to boost a roll. *(Untrained)*
- **Jury-Rig** (INT) — Patch or repurpose tech in a pinch. *(Proficient)*
*Proficiency is binary, same as real D&D — being proficient adds the current proficiency bonus to that skill's rolls. New proficiency choices are granted at levels 4, 8, 12, 16, and 19.*

*Combat mechanics live in world_bible.md → Rules of This World, since they apply to the world/system, not just this character.*
